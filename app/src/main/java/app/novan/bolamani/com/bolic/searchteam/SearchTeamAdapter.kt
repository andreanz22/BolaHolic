...
import app.novan.bolamani.com.bolic.searchmatch.SearchMatchAdapter
import com.squareup.picasso.Picasso
import kotlinx.android.extensions.LayoutContainer
import kotlinx.android.synthetic.main.item_team_list.*

class SearchTeamAdapter(private val context: Context?,
                        private val team:List<Team>,
                        private val listener: (Team) -> Unit): RecyclerView.Adapter<SearchTeamAdapter.ViewHolder>() {
